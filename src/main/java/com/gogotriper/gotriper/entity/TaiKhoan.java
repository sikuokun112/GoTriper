...
public class TaiKhoan {
    ...
    private List<HinhAnh> listUserHinhAnhs;
    ...
    public List<HinhAnh> getListUserImages() {
        return listUserHinhAnhs;
    }

    public void setListUserImages(List<HinhAnh> listUserHinhAnhs) {
        this.listUserHinhAnhs = listUserHinhAnhs;
    }
