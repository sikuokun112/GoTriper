...
export default class Filterizr {
    ...
    private bindEvents;
    /**
     * If it contains hinhAnhs it makes use of the imagesloaded npm package
     * to trigger the first render after the hinhAnhs have finished loading
     * in the DOM. Otherwise, overlapping can occur if the hinhAnhs do not
     * have the height attribute explicitly set on them.
     *
     * In case the grid contains no hinhAnhs, then a simple render is performed.
     */
